defmodule ToyRobot.CLITest do
  ...
  test "shows an error message if the file does not exist" do
    output =
      capture_io(fn ->
        ToyRobot.CLI.main(["dddmdmdmd.txt"])
      end)

    assert output |> String.trim() == "The file dddmdmdmd.txt does not exist"
  end

  # test "handles commands and report successfully" do
  #   commands_path = Path.expand("../fixtures/commands.txt".File.cwd!())
